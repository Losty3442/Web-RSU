...
export const MenuOverlay: React.FC<MenuOverlayProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="fixed inset-0 z-50 bg-primary/95 backdrop-blur-sm p-0 max-w-none h-full">
        <motion.div
          ...
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-white">
                ...
                <p className="text-sm text-white/70">Universidad Nacional de Piura</p>
              </div>
            </div>
            <Button
              variant="ghost"
                              ...
                              {item.children.map((child) => (
                                <Link
                                  ...
                                  className={cn(
                                    ...
                                    isActiveRoute(child.href) && "bg-white/20 text-white font-medium"
                                  )}
                                >
